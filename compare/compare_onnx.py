...
if __name__ == "__main__":
    pt_model, onnx_path = load_models("../models/yolo11n.pt")

    print_architecture(pt_model, onnx_path)

    image_array = preprocess_image("../test_data/test_image.jpg")

    pt_layer_data, pt_layer_name = extract_pytorch_layer(
        pt_model, "../test_data/test_image.jpg", 22
    )
    inspect_layer(pt_layer_data, pt_layer_name, 22)
    visualize_feature_map(
        pt_layer_data, "PyTorch Layer 22", "../viz/pytorch_layer_22.png"
    )

    pt_layer_data, pt_layer_name = extract_pytorch_layer(
        pt_model, "../test_data/test_image.jpg", 23
    )
    inspect_layer(pt_layer_data, pt_layer_name, 23)
    visualize_feature_map(
        pt_layer_data, "PyTorch Layer 23", "../viz/pytorch_layer_23.png"
    )
