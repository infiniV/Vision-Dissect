...
def visualize_models(
    image_path="../test_data/test_image.jpg", layer_idx=7, max_channels=8
):
    models = {
        "v11n": "../models/yolo11n.pt",
        "v11n-seg": "../models/yolo11n-seg.pt",
        "v11n-pose": "../models/yolo11n-pose.pt",
    }
...
def visualize_outputs(image_path="../test_data/test_image.jpg"):
    models = {
        "Detection": "../models/yolo11n.pt",
        "Segmentation": "../models/yolo11n-seg.pt",
...
if __name__ == "__main__":
    visualize_models(
        image_path="../test_data/test_image.jpg", layer_idx=22, max_channels=3
    )
    visualize_outputs(image_path="../test_data/test_image.jpg")
